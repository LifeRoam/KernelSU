...
Java_com_one_attempt_Natives_becomeManager(JNIEnv *env, jobject, jstring pkg) {
...
Java_com_one_attempt_Natives_getVersion(JNIEnv *env, jobject) {
    return get_version();
}

extern "C"
JNIEXPORT jintArray JNICALL
Java_com_one_attempt_Natives_getAllowList(JNIEnv *env, jobject) {
    int uids[1024];
    int size = 0;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_one_attempt_Natives_isSafeMode(JNIEnv *env, jclass clazz) {
    return is_safe_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_one_attempt_Natives_isLkmMode(JNIEnv *env, jclass clazz) {
    return is_lkm_mode();
}
...
Java_com_one_attempt_Natives_getAppProfile(JNIEnv *env, jobject, jstring pkg, jint uid) {
    ...
    auto cls = env->FindClass("com/one/attempt/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_one_attempt_Natives_setAppProfile(JNIEnv *env, jobject clazz, jobject profile) {
    auto cls = env->FindClass("com/one/attempt/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_one_attempt_Natives_uidShouldUmount(JNIEnv *env, jobject thiz, jint uid) {
